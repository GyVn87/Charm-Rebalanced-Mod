...
namespace TuyenTuyenTuyen.Charms {
    internal static class Charm24_Greed {
        private static readonly Dictionary<string, int> trialPrize = new() {
            {"colosseumBronzeCompleted", 1000},
            {"colosseumSilverCompleted", 2000},
            {"colosseumGoldCompleted",   3000},
        };

        private static readonly Dictionary<int, float> geoDropIncrease = new() {
            {1, 0.6f},  // small Geo drop
            {2, 0.4f},  // medium Geo drop
            {3, 0.3f},  // large Geo drop
        };
        ...
        internal static void Load() {
            On.HutongGames.PlayMaker.Fsm.DoTransition += OnFsmDoTransition;
